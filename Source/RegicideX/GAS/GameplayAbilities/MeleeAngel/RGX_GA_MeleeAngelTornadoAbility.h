...
#include "RGX_GA_MeleeAngelTornadoAbility.generated.h"
...
UCLASS()
class REGICIDEX_API URGX_GA_MeleeAngelTornadoAbility : public URGX_GameplayAbility
{
	GENERATED_BODY()

public:

	URGX_GA_MeleeAngelTornadoAbility();
